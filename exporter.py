...
class Exporter:
    ...
    def __init__(
        ...
        self.spreadsheet_name: str = configs["spreadsheet"].get(
            "name", settings.DEFAULT_SHEET_NAME
        )
        self.log = logging.getLogger(self.__class__.__name__)

    def create_sheet(
        self, sheets_service: Resource, spreadsheet_id: str, table_data: Table
    ) -> None:
        ...
        self.log.info(
            f"YouTube links uploaded to '{self.spreadsheet_name}' Google Sheet under tab named '{sheet_title}'"
        )
